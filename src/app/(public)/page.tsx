...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col bg-[#f9f9f9] dark:bg-black">
      ...
      {/* CTA Final */}
      <SectionReveal className="py-24 bg-[#0b0c10] dark:bg-black" offset={40}>
        <div className="container px-4 md:px-6">
          <ScrollAnimation>
                ...
                <Link href="/pricing">
                  ...
                  >
                    <Button 
                      size="lg" 
                      variant="outline"
                      className="border-2 border-white text-white hover:bg-white hover:text-[#0b0c10] rounded-full px-8 py-6 text-lg font-semibold"
                    >
                      Ver Créditos
                    </Button>
                  </motion.div>
