# 🗄️ Como Executar a Migration voice_clones

## ⚠️ Problema

O erro `Could not find the table 'public.voice_clones' in the schema cache` significa que a tabela não existe. A migration precisa ser executada no Supabase.
...
Após executar o SQL, tente fazer upload de áudio novamente.

## ✅ Checklist

- [ ] SQL executado no Supabase
- [ ] Tabelas criadas (verificar no Table Editor)
- [ ] Bucket `voice-clones` criado no Storage (veja `CONFIGURAR_BUCKET_SUPABASE.md`)
